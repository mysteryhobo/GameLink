...
kalahTournament:
	...
	javac -Xlint:unchecked -d $(PathName)/classes org/gamelink/tournament/*.java; \
	cd $(PathName)/classes; \
	java -Xms2048m -Xmx16384m org.gamelink.main.KalahTournamentSimulator 0 0
...
kalahDistributedTournamentPlayer1:
	...
	javac -Xlint:unchecked -d $(PathName)/classes org/gamelink/main/KalahTournamentSimulator.java; \
	cd $(PathName)/classes; \
	java -Xms2048m -Xmx16384m org.gamelink.main.KalahTournamentSimulator 1 0
...
kalahDistributedTournamentPlayer2:
	...
	javac -Xlint:unchecked -d $(PathName)/classes org/gamelink/main/KalahTournamentSimulator.java; \
	cd $(PathName)/classes; \
	java -Xms2048m -Xmx16384m org.gamelink.main.KalahTournamentSimulator 2 0
